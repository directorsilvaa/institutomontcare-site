...
const faqItems = [
  {
    ...
    answer: "É um atendimento focado na rápida resolução dos problemas ortopédicos, com ênfase em tratamentos conservadores e cirúrgicos minimamente invasivos."
  },
  {
...
const testimonials = [
  {
    quote: "Fui atendida com muita atenção desde a primeira consulta. O diagnóstico foi claro e o tratamento trouxe melhora real para minha rotina.",
    name: "M.S.",
    detail: "Paciente"
  },
  {
    quote: "Equipe extremamente profissional, ambiente acolhedor e um cuidado que transmite confiança em cada etapa do atendimento.",
    name: "C.R.",
    detail: "Paciente"
  },
  {
    quote: "Depois de muito tempo com dor, encontrei um acompanhamento sério e resolutivo. Hoje voltei a me movimentar com segurança.",
    name: "F.L.",
    detail: "Paciente"
  },
  {
    quote: "A consulta foi objetiva, acolhedora e muito esclarecedora. Saí com segurança no tratamento e ótimo acompanhamento.",
    name: "P.M.",
    detail: "Paciente"
  },
  {
    quote: "Profissionais muito preparados e atendimento excelente. Todo o processo foi conduzido com clareza e muito cuidado.",
    name: "E.T.",
    detail: "Paciente"
  },
  {
    quote: "Gostei muito da forma como explicaram meu caso e das opções de tratamento. O cuidado foi diferenciado do começo ao fim.",
    name: "J.P.",
    detail: "Paciente"
  }
];
const doctors = [
  {
    ...
    crm: "CRM 392744",
    image: "/time/1.webp",
    summary: "Atendimento voltado ao cuidado nutricional feminino, com abordagem clínica individualizada e foco em saúde, performance e qualidade de vida."
  },
  {
    name: "Gustavo Bisson",
    specialty: "Ortopedia",
    ...
    image: "/time/2.webp",
    summary: "Cirurgia de coluna vertebral com foco em diagnóstico preciso, segurança terapêutica e cuidado humanizado."
  },
  {
    ...
    image: "/time/3.webp",
    summary: "Médico sócio, ortopedista e cirurgião de coluna, com fellowship pelo IAMSPE, formação em cirurgia minimamente invasiva pela USP Ribeirão Preto e atuação em casos de alta complexidade."
  },
  {
    ...
    crm: "CREFITO 200467",
    image: "/time/4.webp",
    summary: "Reabilitação ortopédica com foco em funcionalidade, controle da dor e recuperação do movimento com abordagem individualizada."
  },
  {
    ...
    image: "/time/5.webp",
    summary: "Atendimento especializado em infectologia, com avaliação criteriosa, orientação segura e acompanhamento clínico individualizado."
  },
  {
    name: "Ocilmar Junior",
    ...
    image: "/time/6.webp",
    summary: "Cirurgia de quadril com abordagem especializada, foco em precisão técnica e melhora da qualidade de vida."
  },
  {
    ...
    image: "/time/7.webp",
    summary: "Cirurgia, reconstrução e estética mamária com atendimento especializado, cuidado humanizado e foco em segurança clínica."
  }
];
const rehabBenefits = [
...
const rehabFaqItems = [
  {
    ...
    answer: "O programa pode ser indicado para quadros pós-cirúrgicos, lesões ortopédicas, dores persistentes, perda de mobilidade e limitações funcionais. A confirmação acontece após avaliação médica individualizada."
  },
  {
    question: "Quanto tempo dura o processo de reabilitação?",
    answer: "O tempo varia conforme o diagnóstico, a gravidade do quadro e a resposta clínica de cada paciente. Após a avaliação, definimos metas e uma estimativa de progressão segura."
  },
  {
    question: "Existe necessidade de cirurgia para iniciar a reabilitação?",
    answer: "Não. Muitos pacientes iniciam a reabilitação sem cirurgia, com foco em controle da dor, ganho de mobilidade, fortalecimento e prevenção de piora funcional."
  },
  {
    question: "Terei alta clínica?",
    answer: "Sim. O acompanhamento é conduzido com objetivos funcionais claros, e a alta é considerada quando há recuperação adequada, estabilidade clínica e retorno seguro às atividades."
  },
  {
    question: "Qual é o custo da reabilitação?",
    answer: "O investimento depende da avaliação do caso e da estrutura do plano terapêutico. A equipe orienta os detalhes de atendimento e valores após o primeiro contato."
  }
];
...
const arthrodesisFaqItems = [
  {
    ...
    answer: "Não. A artrodese é indicada quando há instabilidade, deformidades, degeneração avançada ou compressões que exigem estabilização estrutural da coluna para melhor controle da dor e proteção funcional."
  },
  {
    question: "A cirurgia é comum?",
    answer: "É um procedimento consagrado na cirurgia de coluna, especialmente em casos selecionados com critério. A indicação depende da avaliação clínica, dos sintomas e dos exames de imagem."
  },
  {
    question: "A artrodese limita os movimentos?",
    answer: "A cirurgia estabiliza segmentos específicos da coluna. O objetivo é reduzir dor e instabilidade preservando ao máximo a funcionalidade global do paciente."
  },
  {
    question: "Qual é o tempo de recuperação?",
    answer: "A recuperação varia conforme o número de níveis tratados, a técnica utilizada e a resposta individual. O pós-operatório é acompanhado de perto para evolução segura e progressiva."
  }
];
...
const infiltrationFaqItems = [
  {
    ...
    answer: "Pode haver desconforto leve e momentâneo durante a aplicação, mas o procedimento é feito com técnica cuidadosa para tornar a experiência mais tolerável e segura."
  },
  {
    question: "A infiltração substitui a fisioterapia ou a cirurgia?",
    answer: "Não necessariamente. A infiltração é uma ferramenta terapêutica que pode fazer parte de um plano mais amplo, associado a reabilitação, fortalecimento ou outras abordagens."
  },
  {
    question: "Existem riscos ou efeitos colaterais?",
    answer: "Como qualquer procedimento médico, há riscos pontuais, mas eles são reduzidos quando a indicação é correta e a aplicação é realizada com técnica adequada e acompanhamento especializado."
  },
  {
    question: "A infiltração oferece alívio imediato?",
    answer: "Alguns pacientes percebem melhora rápida, enquanto outros evoluem de forma gradual. A resposta depende do quadro, da substância utilizada e do objetivo terapêutico definido na avaliação."
  }
];
...
const minimallyInvasiveFaqItems = [
  {
    ...
    answer: "O procedimento pode causar desconforto no pós-operatório, mas técnicas minimamente invasivas costumam reduzir a agressão local e favorecer uma recuperação mais confortável em casos bem indicados."
  },
  {
    question: "Quanto tempo leva a recuperação?",
    answer: "O tempo varia conforme o tipo de cirurgia, a região tratada e a resposta de cada paciente. Em muitos casos, a recuperação funcional tende a ser mais rápida do que em abordagens convencionais."
  },
  {
    question: "Ficam cicatrizes visíveis?",
    answer: "As incisões tendem a ser menores, o que geralmente resulta em cicatrizes mais discretas, sempre considerando as particularidades do procedimento e do processo de cicatrização."
  },
  {
    question: "Os resultados são definitivos?",
    answer: "Os resultados dependem do diagnóstico, da técnica empregada, da resposta biológica e do seguimento adequado. A cirurgia é planejada para resolver o problema com o máximo de segurança possível."
  },
  {
      ...
      answers: [
        {
          ...
          answer: "O atendimento acontece na Av. Moaci, 395, 14º andar, Sala 145 — Moema, São Paulo/SP."
        },
        {
...
function buildStructuredData(meta, siteOrigin) {
  ...
  const pagePath = (meta == null ? void 0 : meta.path) || "/";
  ...
  if ((_a = meta.faq) == null ? void 0 : _a.length) {
    structuredData.push({
      "@context": "https://schema.org",
      "@type": "FAQPage",
      "@id": `${pageUrl}#faq`,
...
function Header({ isInnerPage = false }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: `navbar${isInnerPage ? " navbar-solid" : ""}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "brand", href: isInnerPage ? getHomeHref() : "#home", "aria-label": "Logo da empresa", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "nav-menu-desktop", "aria-label": "Navegação principal", children: [
      navItems.slice(0, 2).map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "nav-dropdown", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Soluções" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "nav-caret", "aria-hidden": "true" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dropdown-menu", children: procedures.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: getProcedureHref(item.title), className: "dropdown-link", children: item.title }, item.title)) })
      ] }),
      navItems.slice(2).map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "nav",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mobile-drawer-group", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mobile-drawer-label", children: "Soluções" }),
            procedures.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "contact-arrow", "aria-hidden": "true" })
              ]
            }
          )
        ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { className: "contact-button contact-button-desktop", href: PHONE_HREF, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Ligar" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "contact-arrow", "aria-hidden": "true" })
    ] })
  ] });
...
function FooterIcon({ type }) {
  const paths = {
    phone: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M7.2 4.6c.3-.3.8-.4 1.2-.2l2.1 1c.5.2.7.8.5 1.3l-.7 1.6c.8 1.4 2 2.6 3.4 3.4l1.6-.7c.5-.2 1.1 0 1.3.5l1 2.1c.2.4.1.9-.2 1.2l-1.1 1.1c-.6.6-1.5.8-2.3.5C9.9 15.1 6.9 12.1 5.6 8c-.3-.8-.1-1.7.5-2.3l1.1-1.1Z" }),
    mail: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M4.8 6.5h14.4v11H4.8v-11Z" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "m5.2 7.1 6.8 5.3 6.8-5.3" })
    ] }),
    location: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M12 20s6-5.1 6-10a6 6 0 0 0-12 0c0 4.9 6 10 6 10Z" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M12 12.2a2.2 2.2 0 1 0 0-4.4 2.2 2.2 0 0 0 0 4.4Z" })
    ] })
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "footer-contact-icon", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { viewBox: "0 0 24 24", focusable: "false", children: paths[type] }) });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "site-footer", id: "agendamento", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "footer-shell", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "footer-brand", "data-footer-reveal": true, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "footer-summary", children: "Ortopedia resolutiva com atendimento humanizado, estrutura moderna e foco em cuidado real para mais mobilidade e qualidade de vida." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "footer-legal", children: [
          "Responsável Técnico:",
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          "Dr. Gustavo Bisson | CRM 151542 SP"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "footer-contact", "data-footer-reveal": true, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Atendimento" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "footer-nav", "aria-label": "Navegação do rodapé", "data-footer-reveal": true, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Navegação" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: isInnerPage ? getHomeHref() : "#home", children: "Home" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: getSectionHref("quem-somos", isInnerPage), children: "Quem somos" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", children: "Blog" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: getSectionHref("procedimentos", isInnerPage), children: "Soluções" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: getSectionHref("duvidas", isInnerPage), children: "FAQ" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "footer-bottom", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "data-footer-credit-reveal": true, children: "Desenvolvido por " }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
          ...
          "data-footer-credit-reveal": true,
...
function HomePage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-shell", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "hero-section", id: "home", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("picture", { className: "hero-media", "aria-hidden": "true", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("source", { srcSet: withBase("/bg-hero-mobile.webp"), media: "(max-width: 760px)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hero-overlay", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "hero-content", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "hero-title", children: [
          "Ortopedia resolutiva ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "para mais qualidade de vida." })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "about-section", id: "quem-somos", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "about-shell", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "about-media", "data-reveal": true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "about-image-frame", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "specialties-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "specialties-shell", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "specialties-title", "data-reveal": true, children: "ESPECIALIDADES" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "specialties-description", "data-reveal": true, children: "Áreas de atuação com abordagem precisa, visão integrada e foco em devolver conforto, movimento e qualidade de vida." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "specialties-grid", children: specialties.map((specialty, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "specialty-card", "data-reveal": true, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "specialty-index", "aria-hidden": "true", children: index + 1 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "specialty-icon-frame", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "specialty-card-line", "aria-hidden": "true" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: specialty.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: specialty.description })
      ] }, specialty.title)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "specialties-button", href: WHATSAPP_HREF, target: "_blank", rel: "noreferrer", "data-reveal": true, children: "Agende sua consulta" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "team-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "team-shell", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "team-header", "data-reveal": true, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "team-eyebrow", children: "CORPO CLÍNICO" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "team-title", children: "Cuidado completo para cada paciente" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "team-description", children: "Um corpo clínico diversificado permite cuidar do paciente como um todo, integrando diferentes especialidades e níveis de tratamento. O acompanhamento pode começar em uma fisioterapia simples e evoluir, quando necessário, para cirurgias complexas como artrodeses, discectomias e outros procedimentos ortopédicos especializados." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "team-carousel", "data-reveal": true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "team-track", children: [...doctors, ...doctors].map((doctor, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "doctor-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "doctor-card-body", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: doctor.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "doctor-role", children: doctor.specialty }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "doctor-crm", children: doctor.crm }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "doctor-divider", "aria-hidden": "true" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "doctor-summary", children: doctor.summary })
        ] })
      ] }, `${doctor.name}-${doctor.image}-${index}`)) }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "faq-section", id: "duvidas", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "faq-shell", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "faq-copy", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "faq-title", "data-reveal": true, children: "PERGUNTAS FREQUENTES" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "faq-list", children: faqItems.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("details", { className: "faq-item", open: index === 0, "data-reveal": true, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("summary", { className: "faq-question", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: item.question }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "faq-icon", "aria-hidden": "true", children: index === 0 ? "-" : "+" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "faq-answer", children: item.answer })
      ] }, item.question)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "faq-button", href: WHATSAPP_HREF, target: "_blank", rel: "noreferrer", "data-reveal": true, children: "Agende sua consulta" })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "testimonials-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "testimonials-shell", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "testimonials-header", "data-reveal": true, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "testimonials-eyebrow", children: "EXPERIÊNCIA DOS PACIENTES" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "testimonials-title", children: "Depoimentos" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "testimonials-description", children: "Relatos de pacientes que encontraram acolhimento, clareza no diagnóstico e um cuidado ortopédico voltado a resultados reais." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "testimonials-carousel", "data-reveal": true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "testimonials-track", children: [...testimonials, ...testimonials].map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "testimonial-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "testimonial-rating", "aria-label": "5 estrelas", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "testimonial-quote", children: [
          '"',
          item.quote,
          '"'
        ] }),
...
function RehabPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-page-shell", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { isInnerPage: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "rehab-hero", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-hero-overlay", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rehab-hero-content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-eyebrow", children: "REABILITAÇÃO ORTOPÉDICA" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Reabilitação Ortopédica com foco na recuperação de movimento e autonomia" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Avaliação médica individualizada para reabilitação após lesões ortopédicas, cirurgias ou disfunções articulares." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "rehab-primary-button", href: WHATSAPP_HREF, target: "_blank", rel: "noreferrer", children: "Agendar minha avaliação" })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "rehab-story-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-story-shell", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-story-copy", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Perder mobilidade afeta mais do que o corpo, compromete sua rotina." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Seja após um trauma, cirurgia ou por limitações progressivas, a dificuldade em realizar movimentos compromete a independência e a qualidade de vida. Dores crônicas, rigidez articular e desequilíbrios musculares podem evoluir sem tratamento adequado, impactando atividades simples como caminhar, levantar ou carregar objetos." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "A reabilitação funcional busca restaurar o equilíbrio do sistema musculoesquelético, reduzir compensações e devolver confiança para o retorno progressivo às atividades." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-plan-media", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-photo-frame rehab-photo-frame-compact", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: withBase("/reb/2_3.webp"), alt: "Paciente com limitação de mobilidade em avaliação ortopédica" }) }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "rehab-plan-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-plan-shell", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-plan-copy", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Reabilitação estruturada com acompanhamento médico e foco funcional" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No Instituto Montcare, a reabilitação funcional é conduzida a partir de uma avaliação ortopédica criteriosa. O plano é estruturado de forma personalizada, combinando técnicas de fortalecimento, mobilidade, propriocepção e controle da dor." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "O acompanhamento é constante, com foco em progressão gradual, prevenção de recidivas e retorno seguro às atividades do dia a dia." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-highlight-list", children: rehabHighlights.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-highlight-item", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-highlight-dot", "aria-hidden": "true" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: item })
        ] }, item)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-benefits", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Benefícios esperados:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { children: rehabBenefits.map((benefit) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: benefit }, benefit)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "rehab-primary-button", href: WHATSAPP_HREF, target: "_blank", rel: "noreferrer", children: "Agendar minha avaliação" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-plan-media", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-photo-frame", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: withBase("/reb/1_3.webp"), alt: "Atendimento de reabilitação ortopédica" }) }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "rehab-process-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-process-shell", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-process-header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-section-kicker", children: "COMO FUNCIONA" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Como funciona" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-process-grid", children: rehabJourney.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "rehab-process-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-process-number", children: item.step }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: item.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: item.description })
      ] }, item.step)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "rehab-process-button", href: WHATSAPP_HREF, target: "_blank", rel: "noreferrer", children: "Agendar minha avaliação" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "rehab-about-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-about-shell", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-about-copy", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-section-kicker", children: "SOBRE O INSTITUTO" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Sobre o Instituto Montcare" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Somos referência em ortopedia resolutiva, com uma atuação centrada em diagnóstico preciso, estratégia terapêutica individualizada e acompanhamento próximo ao paciente." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Em cada etapa da reabilitação, buscamos mais do que aliviar sintomas: nosso objetivo é recuperar função, devolver autonomia e conduzir o retorno seguro às atividades da vida diária." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-doctor-quote", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Dr. Gustavo Bisson" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Responsável técnico e acompanhamento clínico especializado" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "A proposta do Instituto Montcare é tratar cada caso com clareza clínica, metas funcionais realistas e evolução monitorada, para que o paciente retome movimento com segurança e confiança." })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-about-media", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-about-photo-frame", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: withBase("/time/2.webp"), alt: "Dr. Gustavo Bisson" }) }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "rehab-faq-section", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-faq-shell", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-faq-copy", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-section-kicker", children: "PERGUNTAS FREQUENTES" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Perguntas frequentes" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-faq-list", children: rehabFaqItems.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("details", { className: "rehab-faq-item", open: index === 0, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("summary", { className: "rehab-faq-question", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: item.question }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-faq-icon", "aria-hidden": "true", children: "+" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "rehab-faq-answer", children: item.answer })
      ] }, item.question)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "rehab-inline-button", href: WHATSAPP_HREF, target: "_blank", rel: "noreferrer", children: "Agendar minha avaliação" })
    ] }) }) }),
...
function ArthrodesisPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-page-shell", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { isInnerPage: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "rehab-hero art-hero", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-hero-overlay", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rehab-hero-content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-eyebrow", children: "ARTRODESES" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Artrodese da coluna: estabilidade para quadros complexos e dor crônica" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Cirurgia com foco na fixação e alinhamento da coluna vertebral em casos de instabilidade, deformidades ou desgaste avançado." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "rehab-primary-button", href: WHATSAPP_HREF, target: "_blank", rel: "noreferrer", children: "Agendar minha avaliação" })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "rehab-story-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-story-shell", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-story-copy", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Dores crônicas e instabilidade na coluna podem afetar sua qualidade de vida e autonomia" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Instabilidades vertebrais, artroses severas, deformidades estruturais e desgaste de discos podem comprometer sustentação, equilíbrio e conforto funcional. Quando a coluna perde estabilidade, a dor tende a se tornar persistente e limitante." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Em quadros com comprometimento mecânico ou neurológico relevante, a artrodese pode ser uma alternativa para restaurar alinhamento, proteger estruturas nervosas e devolver mais segurança ao movimento." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-plan-media", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-photo-frame rehab-photo-frame-compact", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: withBase("/artrod/1_2.webp"), alt: "Dor e desconforto na região da coluna" }) }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "rehab-plan-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-plan-shell", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-plan-copy", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Soluções cirúrgicas modernas com técnicas de baixa agressividade" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "A artrodese vertebral pode ser realizada para promover a fusão de duas ou mais vértebras, reduzindo micromovimentos dolorosos e oferecendo estabilidade à coluna. O planejamento é individualizado, com definição da técnica e dos níveis tratados conforme cada caso." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No Instituto Montcare, a indicação cirúrgica é feita com critério, baseada em exame, sintomas e imagem, sempre buscando segurança, alinhamento e melhor perspectiva funcional no longo prazo." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-highlight-list", children: arthrodesisHighlights.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-highlight-item", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-highlight-dot", "aria-hidden": "true" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: item })
        ] }, item)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-benefits", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Benefícios esperados:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { children: arthrodesisBenefits.map((benefit) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: benefit }, benefit)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "rehab-primary-button", href: WHATSAPP_HREF, target: "_blank", rel: "noreferrer", children: "Agendar minha avaliação" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-plan-media", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-photo-frame", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: withBase("/artrod/2_1.webp"), alt: "Imagem médica da coluna para planejamento de artrodese" }) }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "rehab-process-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-process-shell", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-process-header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-section-kicker", children: "COMO FUNCIONA" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-process-grid", children: arthrodesisJourney.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "rehab-process-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-process-number", children: item.step }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: item.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: item.description })
      ] }, item.step)) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "rehab-about-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-about-shell", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-about-copy", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-section-kicker", children: "SOBRE O INSTITUTO" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Sobre o Instituto Montcare" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Somos referência em cirurgia de coluna com abordagem resolutiva, avaliação criteriosa e decisão clínica orientada por evidência e experiência cirúrgica." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Nossa proposta é indicar procedimentos apenas quando realmente necessários, com planejamento individualizado, condução técnica precisa e seguimento próximo em todas as etapas do tratamento." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-doctor-quote", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Dr. Gustavo Bisson" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Cirurgia da coluna com avaliação especializada" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Cada indicação de artrodese deve ser cuidadosamente construída. O foco é estabilizar a coluna quando necessário, aliviar dor relevante e preservar a melhor funcionalidade possível para o paciente." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "rehab-inline-button", href: WHATSAPP_HREF, target: "_blank", rel: "noreferrer", children: "Agendar minha avaliação" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-about-media", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-about-photo-frame", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: withBase("/time/2.webp"), alt: "Dr. Gustavo Bisson" }) }) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "rehab-faq-section", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-faq-shell", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-faq-copy", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-section-kicker", children: "PERGUNTAS FREQUENTES" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Perguntas frequentes" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-faq-list", children: arthrodesisFaqItems.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("details", { className: "rehab-faq-item", open: index === 0, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("summary", { className: "rehab-faq-question", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: item.question }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-faq-icon", "aria-hidden": "true", children: "+" })
        ] }),
...
function InfiltrationsPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-page-shell", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { isInnerPage: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "rehab-hero infil-hero", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-hero-overlay", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rehab-hero-content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-eyebrow", children: "INFILTRAÇÕES" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Infiltrações ortopédicas com foco em alívio da dor e ganho funcional" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Procedimento direcionado para controle da dor e da inflamação em articulações, tendões e estruturas periarticulares com indicação individualizada." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "rehab-primary-button", href: WHATSAPP_HREF, target: "_blank", rel: "noreferrer", children: "Agendar minha avaliação" })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "rehab-story-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-story-shell", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-story-copy", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "A dor articular limita sua vida no dia a dia?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Dores em articulações e inflamações localizadas, mesmo em menor intensidade, podem limitar tarefas simples, prejudicar movimento e reduzir qualidade de vida. Em muitos casos, o desconforto persiste mesmo com medidas iniciais." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Quando há indicação médica, a infiltração pode ser uma alternativa para atuar diretamente na área afetada e ajudar no controle da dor com ação local." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-plan-media", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-photo-frame rehab-photo-frame-compact", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: withBase("/inf/1_2.webp"), alt: "Dor articular e limitação funcional no dia a dia" }) }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "rehab-plan-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-plan-shell", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-plan-copy", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Infiltrações e acompanhamento especializado podem trazer bons resultados" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No Instituto Montcare, as infiltrações são realizadas com acompanhamento especializado e indicação individualizada, após avaliação clínica detalhada. O procedimento pode ser uma possibilidade de suporte no manejo da dor e da inflamação em diferentes condições ortopédicas." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "A decisão considera o diagnóstico, a intensidade dos sintomas, a região acometida e os objetivos terapêuticos do paciente, sempre com foco em funcionalidade e segurança." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-highlight-list", children: infiltrationHighlights.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-highlight-item", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-highlight-dot", "aria-hidden": "true" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: item })
        ] }, item)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-benefits", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Benefícios esperados:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { children: infiltrationBenefits.map((benefit) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: benefit }, benefit)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "rehab-primary-button", href: WHATSAPP_HREF, target: "_blank", rel: "noreferrer", children: "Agendar minha avaliação" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-plan-media", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-photo-frame", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: withBase("/inf/2_2.webp"), alt: "Procedimento ortopédico com foco em infiltração e dor articular" }) }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "rehab-process-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-process-shell", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-process-header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-section-kicker", children: "COMO FUNCIONA" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-process-grid", children: infiltrationJourney.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "rehab-process-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-process-number", children: item.step }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: item.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: item.description })
      ] }, item.step)) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "rehab-about-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-about-shell", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-about-copy", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-section-kicker", children: "SOBRE O INSTITUTO" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Sobre o Instituto Montcare" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Nossa atuação combina ortopedia resolutiva, avaliação clínica cuidadosa e indicação terapêutica individualizada, sempre com foco em alívio real de sintomas e preservação funcional." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Em procedimentos como infiltrações, a decisão é sempre construída com critério para que o paciente tenha clareza sobre benefícios, limites e melhor estratégia para o seu caso." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-doctor-quote", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Dr. Gustavo Bisson" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Avaliação ortopédica e conduta terapêutica especializada" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "A infiltração precisa ter objetivo clínico claro. Mais do que aplicar um procedimento, buscamos entender a origem da dor e indicar a melhor conduta para cada paciente." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "rehab-inline-button", href: WHATSAPP_HREF, target: "_blank", rel: "noreferrer", children: "Agendar minha avaliação" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-about-media", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-about-photo-frame", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: withBase("/time/2.webp"), alt: "Dr. Gustavo Bisson" }) }) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "rehab-faq-section", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-faq-shell", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-faq-copy", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-section-kicker", children: "PERGUNTAS FREQUENTES" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Perguntas frequentes" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-faq-list", children: infiltrationFaqItems.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("details", { className: "rehab-faq-item", open: index === 0, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("summary", { className: "rehab-faq-question", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: item.question }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-faq-icon", "aria-hidden": "true", children: "+" })
        ] }),
...
function MinimallyInvasivePage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-page-shell", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { isInnerPage: true }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "rehab-hero mini-hero", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-hero-overlay", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "rehab-hero-content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-eyebrow", children: "CIRURGIAS MINIMAMENTE INVASIVAS" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Cirurgias minimamente invasivas com foco em precisão e recuperação funcional" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Abordagens cirúrgicas modernas para tratar diferentes quadros ortopédicos com menor agressão tecidual, quando bem indicadas." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "rehab-primary-button", href: WHATSAPP_HREF, target: "_blank", rel: "noreferrer", children: "Agendar minha avaliação" })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "rehab-story-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-story-shell", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-story-copy", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Quando o tratamento conservador não é mais suficiente, a técnica cirúrgica adequada faz diferença." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Alguns quadros ortopédicos, como lesões articulares, desgastes estruturais e compressões persistentes, podem exigir tratamento cirúrgico para restaurar função e controlar sintomas com mais efetividade." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Nas cirurgias minimamente invasivas, pequenas incisões, precisão instrumental e menor manipulação de estruturas ao redor podem contribuir para recuperação mais rápida e melhor conforto no pós-operatório, em casos selecionados." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-plan-media", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-photo-frame rehab-photo-frame-compact", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: withBase("/Ciru/1_1.webp"), alt: "Representação de cirurgia minimamente invasiva" }) }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "rehab-plan-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-plan-shell", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-plan-copy", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Soluções cirúrgicas modernas com técnicas de baixa agressividade" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Utilizamos recursos modernos de planejamento e execução para selecionar abordagens cirúrgicas menos invasivas quando há benefício clínico real. Essas técnicas buscam preservar tecidos, reduzir trauma local e permitir reabilitação mais eficiente." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Cada procedimento é indicado de forma individualizada, considerando diagnóstico, biomecânica da lesão, limitações funcionais e expectativas do paciente, sempre com foco em segurança e resultado." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-highlight-list", children: minimallyInvasiveHighlights.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-highlight-item", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-highlight-dot", "aria-hidden": "true" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: item })
        ] }, item)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-benefits", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Benefícios esperados:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { children: minimallyInvasiveBenefits.map((benefit) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: benefit }, benefit)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "rehab-primary-button", href: WHATSAPP_HREF, target: "_blank", rel: "noreferrer", children: "Agendar minha avaliação" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-plan-media", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-photo-frame", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: withBase("/Ciru/2_1.webp"), alt: "Equipe em procedimento cirúrgico ortopédico" }) }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "rehab-process-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-process-shell", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-process-header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-section-kicker", children: "COMO FUNCIONA" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-process-grid", children: minimallyInvasiveJourney.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "rehab-process-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-process-number", children: item.step }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: item.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: item.description })
      ] }, item.step)) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "rehab-about-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-about-shell", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-about-copy", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-section-kicker", children: "SOBRE O INSTITUTO" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Sobre o Instituto Montcare" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "O Instituto Montcare trabalha com visão moderna de ortopedia cirúrgica, unindo avaliação técnica rigorosa, indicação responsável e condutas orientadas para resultado funcional real." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Em cirurgias minimamente invasivas, nosso foco é oferecer estratégia terapêutica precisa, com equilíbrio entre tecnologia, segurança e recuperação progressiva." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-doctor-quote", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Dr. Gustavo Bisson" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Planejamento cirúrgico e cuidado ortopédico especializado" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "A técnica certa precisa estar a serviço da necessidade do paciente. O objetivo é tratar com precisão, minimizar agressões desnecessárias e favorecer uma boa evolução pós-operatória." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "rehab-inline-button", href: WHATSAPP_HREF, target: "_blank", rel: "noreferrer", children: "Agendar minha avaliação" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-about-media", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-about-photo-frame", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: withBase("/time/2.webp"), alt: "Dr. Gustavo Bisson" }) }) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "rehab-faq-section", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-faq-shell", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rehab-faq-copy", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-section-kicker", children: "PERGUNTAS FREQUENTES" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Perguntas frequentes" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rehab-faq-list", children: minimallyInvasiveFaqItems.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("details", { className: "rehab-faq-item", open: index === 0, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("summary", { className: "rehab-faq-question", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: item.question }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rehab-faq-icon", "aria-hidden": "true", children: "+" })
        ] }),
...
function App({ initialPage } = {}) {
  ...
  if (isRehabPage) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(RehabPage, {});
  }
  if (isArthrodesisPage) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(ArthrodesisPage, {});
  }
  if (isInfiltrationPage) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(InfiltrationsPage, {});
  }
  if (isMinimallyInvasivePage) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(MinimallyInvasivePage, {});
  }
...
function enhanceStaticPage(root) {
  ...
  const setMobileMenuOpen = (isOpen) => {
    toggle == null ? void 0 : toggle.classList.toggle("is-open", isOpen);
    backdrop == null ? void 0 : backdrop.classList.toggle("is-open", isOpen);
    drawer == null ? void 0 : drawer.classList.toggle("mobile-drawer-open", isOpen);
    document.body.classList.toggle("body-mobile-menu-open", isOpen);
    toggle == null ? void 0 : toggle.setAttribute("aria-expanded", String(isOpen));
    toggle == null ? void 0 : toggle.setAttribute("aria-label", isOpen ? "Fechar menu" : "Abrir menu");
  };
  toggle == null ? void 0 : toggle.addEventListener("click", () => setMobileMenuOpen(!toggle.classList.contains("is-open")));
  backdrop == null ? void 0 : backdrop.addEventListener("click", () => setMobileMenuOpen(false));
